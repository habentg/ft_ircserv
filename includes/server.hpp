...
class Server {
    ...
    public:
        ...
        std::string                 constructReplayMsg(Client *senderClient, Command *cmd, std::string recieverNick);
        ...
        void      createChannel(std::string chanName, std::string key, Client *creator); // gonna call the constructor of the channel class
