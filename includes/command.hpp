...
class Command {
    public:
        ...
        void    privmsg(Client *senderClient, Server *serverInstance, std::string rcver);
        void    notice(Client *senderClient, Server *serverInstance, std::string reciever);
        void    join(Client *senderClient, Server *serverInstance, std::string chanName);
